...
const TopBarberShop = () => {
    ...
    return (<div className="w-screen flex flex-col items-center h-screen bg-white text-tertiary">
      ...
      <div className="w-2/3 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 p-4">
        {data.map((datum, index) => (<div key={index} className="bg-white text-tertiary p-4 rounded-lg shadow-lg">
            <img src={datum.barberShopProfileLink} alt={datum.barberShopName} className="w-full h-40 object-cover rounded-t-lg"/>
